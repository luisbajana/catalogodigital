...
class CategoriaControllerTest < ActionController::TestCase
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post :create, categorium: { catalogo_id: @categorium.catalogo_id, descripcion: @categorium.descripcion, nombre: @categorium.nombre }
    end
  ...
  test "should update categorium" do
    put :update, id: @categorium, categorium: { catalogo_id: @categorium.catalogo_id, descripcion: @categorium.descripcion, nombre: @categorium.nombre }
    assert_redirected_to categorium_path(assigns(:categorium))
  end
